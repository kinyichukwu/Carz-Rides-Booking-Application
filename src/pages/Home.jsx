...
export const Home = () => {
  ...
  const [routeMenu, setRouteMenu] = useState(["special", ""]);
  ...
  const setRoute1 = () => {
    if (routeMenu[0] !== "special") {
      setRouteMenu(["special", ""]);
    }
  };
  const setRoute2 = () => {
    if (routeMenu[1] !== "special") {
      setRouteMenu([" ", "special"]);
    }
  };
  ...
  return (
    <div className="Home">
      ...
      <div className={"homepage container " + openMenuMobile[1]}>
        <div className="homepage__modal">
          ...
          <div className="homepage__modal--container">
            <div className="homepage__modal--container-first">
              {/** */}
              <div
                className={"circle-button " + routeMenu[0]}
                onClick={setRoute1}
              >
              ...
              <div
                className={"circle-button " + routeMenu[1]}
                onClick={setRoute2}
              >
                <span className="circle">
                  <span className="inner-circle"></span>
            ...
            <div className="homepage__modal--container-forth">
              ...
              <p>
                By proceeding, you agree to terms and conditions of Rajlo Inc.
              </p>
            </div>
          </div>
        </div>
